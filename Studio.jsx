    ...
    <div className="pt-24 pb-16 px-4 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm font-mono">Create your lyric reel in minutes</p>
        </motion.div>
        ...
        <AnimatePresence mode="wait">
          {(step === 1 || step === 2 || step === 5) && (
            <motion.div key={`step-${step}`} initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} transition={{ duration: 0.3 }}
          ...
          {step === 4 && (
            <motion.div key="step-4" initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -40 }} transition={{ duration: 0.3 }} className="max-w-2xl mx-auto">
  ...
  return (
    <div className="glass rounded-2xl overflow-hidden border border-white/10 glow-pink">
      ...
      <div className="flex justify-center p-4">
        <div className="relative overflow-hidden rounded-xl" style={{ width: 180, height: 320 }}>
